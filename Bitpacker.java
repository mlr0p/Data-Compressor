...
class Bitpacker {
	...
	/**
	 * Compute a squence of characters representing the printed version of the bit
	 * stream and output one byte at a time
	 * 
	 * @param uncompressedData An arraylist of phrase numbers
	 */
